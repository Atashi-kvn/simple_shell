...
/**
 * read_line - its for reading a line from the standard input
 * @data: a pointer to the struct of data inputed
 *
 * Return: (Success) if its a positive number
 * ------- (Fail) if its a negative number
 */
 ...
 * @data: is a pointer to the struct of data
 *
 * Return: (Success) if its a positive number
 * ------- (Fail) if its a negative number
 */
...
#define DELIMITER ":"
/**
 * parse_line - for converting parses arguments to valid command
 * @data: is a pointer to the struct of data
 *
 * Return: (Success) if its a positive number
 * ------- (Fail) if its a negative number
...
#undef DELIMITER
/**
 * process_cmd - useful in processing command and execute process
 * @data: is a pointer to the struct of data
 *
 * Return: (Success) if its a positive number
 * ------- (Fail) if its a negative number
