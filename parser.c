#include "shell.h"
/**
 * is_path_form - chk if the given fiken_name is a path
 * @data: is the data strucct pointer
 *
 * Return: (Success)
 * ------- (Fail) otherwise
 */
...
#define DELIMITER ":"
/**
 * is_short_form - chk if the given fiken_name is short fom
 * @data: is the data struct pointer
 *
 * Return: (Success)
 * ------- (Fail) otherwise
 */
...
#undef DELIMITER
/**
 * is_builtin - checks if the comand is builtin
 * @data: is a pointer to the data structure
 *
 * Return: (Success) 0 is returned
 * ------- (Fail) -1 negative number will returned
 */
